...
class HROfficer(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        Index("ix_hr_officers_hr_code", "hr_code"),
    )

    id: Mapped[int] = mapped_column(primary_key=True)
    hr_code: Mapped[str] = mapped_column(String(30), unique=True, nullable=False)
    ...
    creator: Mapped[Optional["CorpAdmin"]] = relationship("CorpAdmin")  # noqa: F821
